...
import com.smlsnnshn.entity.Employee;
...
public interface EmployeeRepository extends JpaRepository<Employee,Integer> {
    ...
    @Query("select e from Employee e where e.email=:salary")
    ...
    Optional<Employee> getEmployeeByFirstNameAndSalary(@Param("name") String name, @Param("salary") int salary);
